...
export interface CveResponse extends BaseSuccess {
  ...
  cwe_id?: string;
  /** v1.28.0 (B4A) — all CWE identifiers, Primary first */
  cwes?: string[];
  /** v1.29.0 (B5) — NVD lifecycle status */
  vulnerability_status?: string;
  /** v1.29.0 (B5) — NVD cveTags (e.g. 'disputed') */
  cve_tags?: string[];
  ...
  /** v1.29.0 (B6A) — unique-URL upstream count */
  total_references_unique?: number;
  /** v1.29.0 (B6B) — [{url, tags, source}] when ?include_reference_tags=true */
  references_full?: Array<Record<string, any>>;
  patch_available?: boolean;
  patch_url?: string;
  sources?: string[];
  /** v1.29.0 (B7) — CVSS v2.0 base score (always emitted) */
  cvss_v2?: number;
  /** v1.29.0 (B7) — CVSS v2.0 vector string */
  cvss_v2_vector?: string;
  /** v1.29.0 (B7) — per-source severity breakdown */
  severity_sources?: Array<Record<string, any>>;
  /** v1.29.0 (B7) — majority-bucket consensus */
  severity_consensus?: string;
  /** v1.29.0 (B7) — true when sources disagree */
...
export interface KevDetailResponse extends BaseSuccess {
  ...
  in_kev?: boolean;
  date_added?: string;
  /** v1.29.0 (B5) — feed update timestamp */
  date_updated?: string;
  /** v1.29.0 (B5) — soft-delete lifecycle (null when still active) */
  date_removed?: string;
  due_date?: string;
...
export interface CvssDetailsResponse extends BaseSuccess {
  version?: string;
  vector?: string;
  base_score?: number;
...
export interface RiskScoreResponse extends BaseSuccess {
  cve_id?: string;
  score?: number;
...
declare function ContrastAPI(options?: {
  ...
  cve: {
    ...
    riskScore(cveId: string): Promise<RiskScoreResponse>;
    /** v1.29.1: parse a CVSS v3.x vector into per-metric breakdown + recomputed score. */
    cvssDetails(vector: string): Promise<CvssDetailsResponse>;
