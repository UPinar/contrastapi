            ...
            "cve": {
                ...
                "tools": [
                    ...
                    },
                    {
                        ...
                        "path": "/v1/cves/bulk",
                        "token_cost": 1,
                        "token_cost_note": "1 token per item in request",
                        "blast_radius": "zero",
            ...
            "domain": {
                ...
                "tools": [
                    ...
                    },
                    {
                        ...
                        "method": None,
                        "path": None,
                        "token_cost": COST_TECH_CVE_AUDIT,
                        "blast_radius": "high",
                    ...
                    },
                    {
                        ...
                        "token_cost": 1,
                        "blast_radius": "low",
                        "description": "Deterministic GEO / AI-visibility readiness audit of a domain's homepage with a 0-100 score (7 rules: llms.txt, AI-crawler robots access, schema.org @types, SSR vs SPA, OG/canonical/sitemap, semantic headings, comparison content). No LLM is queried. Honours robots.txt.",
                        "response_keys": [
                            "domain",
                            "fetched_url",
                            "status_code",
            ...
            "code_security": {
                ...
                "tools": [
                    ...
                    },
                    {
                        ...
                        "token_cost": 1,
                        "token_cost_note": "1 token per package in request",
                        "blast_radius": "zero",
            ...
            "d3fend": {
                ...
                "tools": [
                    ...
                    },
                    {
                        ...
                        "token_cost": 1,
                        "token_cost_note": "1 token per request (not per T-code)",
                        "blast_radius": "zero",
            ...
            "sigma": {
                ...
                "tools": [
                    ...
                    },
                    {
                        ...
                        "path": "/v1/sigma/bulk",
                        "token_cost": 1,
                        "token_cost_note": "1 token per rule_id (each id counts)",
                        "blast_radius": "zero",
