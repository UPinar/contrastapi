...
HTML_RULES = [
    # CMS
    ("WordPress", "CMS",
     [r"wp-content/", r"wp-includes/", r"WordPress\s*[\d.]*"],
     r'WordPress\s+([\d.]+)'),
    ("Drupal", "CMS",
     [r"sites/default/files", r"Drupal\.settings", r"/misc/drupal\.js"],
     r'content=["\']Drupal\s*([\d.]+)'),
    ("Joomla", "CMS",
     [r"/media/jui/", r"/media/system/js/"],
     r'content=["\']Joomla!\s*([\d.]+)'),
    ("Shopify", "CMS",
     [r"cdn\.shopify\.com", r"Shopify\.theme"],
     None),
    ("Squarespace", "CMS",
     [r"static1\.squarespace\.com", r"squarespace-cdn\.com"],
     None),
    ("Wix", "CMS",
     [r"static\.wixstatic\.com", r"wix\.com/"],
     None),
    ("Ghost", "CMS",
     [r'content=["\']Ghost'],
     r'content=["\']Ghost\s*([\d.]+)'),
    ...
    # JS Frameworks
    ("React", "Framework",
     [r"data-reactroot", r"__REACT_DEVTOOLS_", r"_reactRootContainer"],
     None),
    ("Next.js", "Framework",
     [r"__NEXT_DATA__", r"/_next/static/"],
     r'__NEXT_DATA__.*?"version"\s*:\s*"([\d.]+)"'),
    ("Nuxt.js", "Framework",
     [r"__NUXT__", r"/_nuxt/"],
     None),
    ("Angular", "Framework",
     ...
     r'ng-version=["\'](\d+[\d.]*)'),
    ("Vue.js", "Framework",
     [r"__vue__", r"v-cloak", r'data-v-[a-f0-9]'],
     None),
    ("Svelte", "Framework",
     [r"__svelte", r'class="svelte-'],
     None),
    ("Gatsby", "Framework",
     [r"___gatsby", r"/page-data/"],
     None),
    ("Remix", "Framework",
     [r"__remixContext", r"__remixManifest"],
     None),
    # JS Libraries
    ("jQuery", "JavaScript",
     [r"jquery[.\-/][\d.]+", r"jquery\.min\.js"],
     r'jquery[.\-/]([\d]+(?:\.[\d]+)*)'),
    ("Bootstrap", "JavaScript",
     [r"bootstrap[.\-/]([\d.]+)", r"bootstrap\.min\.(js|css)"],
     r'bootstrap[.\-/]([\d.]+)'),
    ("Tailwind CSS", "CSS",
     [r"tailwindcss", r"tailwind\.min\.css"],
     None),
    ("Font Awesome", "JavaScript",
     [r"font-?awesome", r"fontawesome"],
     r'font-?awesome[/\-]([\d.]+)'),
    ("Lodash", "JavaScript",
     [r"lodash[.\-/]([\d.]+)", r"lodash\.min\.js"],
     r'lodash[.\-/]([\d.]+)'),
    # Analytics
    ...
    ("Hotjar", "Analytics",
     ...
     None),
    ("Segment", "Analytics",
     [r"cdn\.segment\.com/analytics"],
     None),
    ("Matomo", "Analytics",
     [r"matomo\.js", r"piwik\.js"],
     None),
    ("Plausible", "Analytics",
     [r"plausible\.io/js/"],
     None),
    ...
    ("Google Fonts", "Font",
     ...
     None),
    ("reCAPTCHA", "Security",
     [r"google\.com/recaptcha", r"gstatic\.com/recaptcha"],
     None),
    ("hCaptcha", "Security",
     [r"hcaptcha\.com"],
     None),
    ("Turbolinks", "JavaScript",
     [r"turbolinks", r"data-turbolinks-track"],
     None),
    ("HTMX", "JavaScript",
     [r"htmx\.org", r"hx-get", r"hx-post"],
     r'htmx\.org@([\d.]+)'),
    ("Alpine.js", "JavaScript",
     [r"alpinejs", r'\bx-data\s*=', r'\bx-bind\s*:'],
     None),
]
