...
[![Tests](https://img.shields.io/badge/Tests-650_passing-brightgreen.svg)](https://github.com/UPinar/contrastapi/actions)
...
650 tests covering auth, rate limiting, validation, database operations, domain intelligence, CVE intelligence, threat intelligence, code security, tech fingerprinting, IP reputation, MCP endpoint, and API routes.
